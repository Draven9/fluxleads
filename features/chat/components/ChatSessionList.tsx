            ...
            <div className="p-4 border-b border-slate-100 bg-white">
                ...
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Buscar..."
                        className="w-full pl-9 pr-4 py-2 bg-slate-100 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:bg-white transition-all"
                    />
                </div>
            </div>
                    ...
                    <div className="divide-y divide-slate-50">
                        {sessions.map((session) => (
                            <button
                                ...
                                className={`w-full p-4 flex items-center space-x-3 hover:bg-slate-50 transition-colors text-left ${selectedSessionId === session.id ? 'bg-primary-50 border-l-4 border-primary-500' : 'border-l-4 border-transparent'
                                    }`}
                            >
                                {/* Avatar */}
                                <div className="relative">
