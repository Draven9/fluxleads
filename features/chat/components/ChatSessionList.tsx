                            ...
                            <div key={session.id} className="relative group">
                                ...
                                {isAdmin && (
                                    <button
                                        ...
                                        className="absolute right-2 top-11 p-2 text-slate-400 hover:text-red-500 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-full opacity-0 group-hover:opacity-100 transition-opacity z-10"
